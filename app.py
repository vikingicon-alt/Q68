...
st.markdown("""
 ...
 .buy-btn { background-color: #00ff88 !important; color: black !important; box-shadow: 0 0 20px #00ff88; }
 .sell-btn { background-color: #ff4b4b !important; color: white !important; box-shadow: 0 0 20px #ff4b4b; }
.hold-btn { background-color: #ffaa00 !important; color: black !important; box-shadow: 0 0 20px #ffaa00; }
  .q68-footer {
...
fig.add_trace(go.Bar(x=data.index, y=data['Volume'], marker_color=vol_colors), row=2, col=1)fig.add_trace(go.Scatter(x=data.index, y=data['RSI'], fill='tozeroy', line=dict(color='#00d1ff'), fillcolor='rgba(0, 209, 255, 0.15)'), row=3, col=1)
